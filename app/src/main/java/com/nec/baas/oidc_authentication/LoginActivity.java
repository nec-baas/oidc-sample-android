...
/**
 * OpenID Connect連携ログイン画面Acttivityクラス
 */
public class LoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        outputMessage.append("-CheckErrorOfAuthentication ---------"
        ...
        // パラメータ"error"の値を取得
        String errPalam = uri.getQueryParameter("error");

        if(errPalam == null){
            outputMessage.append("Authentication succeeded."
                    + System.getProperty("line.separator"));
            ...
            String errMessage = "Authentication failed. ErrorMessage:" + errPalam;
            outputMessage.append(errMessage + System.getProperty("line.separator"));
    ...
    /**
     * OpenID Connect連携により設定されたパラメータをIntentから取り出すメソッド
     * @param intent
